...
namespace Failsafe.DemoScripts
{
    public class CallbackExample : MonoBehaviour
    {
        ...
        public void GeneratorComplete(DungeonGenerator generator) {
        ...
        public void SpawnKeys() {
            ...
            for(int i = 0; i < generator.DungeonGraph.Count; i++) {
                ...
                for(int j = 0; j < room.keyIDs.Count; j++) {
                    ...
                    spawnedKey.GetComponentInChildren<Renderer>().material.color = DungeonGenerator.GetKeyColor(room.keyIDs[j]);
                    spawnedKey.GetComponentInChildren<Light>().color = DungeonGenerator.GetKeyColor(room.keyIDs[j]);
                }
            }
        }
